import { ALLOWED_WORDS, BANNED_WORDS } from './bannedWords.js';

/**
 * Filtre de texte, appliqué ici comme **autorité** : l'application le fait
 * tourner pendant la frappe pour prévenir tout de suite, mais un client
 * modifié peut l'ignorer. C'est la version serveur qui décide de refuser une
 * publication.
 *
 * ⚠️ Ce fichier et `mobile/src/domain/moderation/textModeration.ts` doivent
 * rester identiques.
 *
