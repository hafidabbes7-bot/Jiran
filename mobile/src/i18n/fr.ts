...
export const fr = {
  ...
  onboarding: {
    ...
    methodLabel: 'Comment veux-tu créer ton compte ?',
    methodCode: 'Code à usage unique',
    methodPassword: 'Adresse + mot de passe',
    methodCodeHint: 'Un code arrive par SMS, WhatsApp ou e-mail. Rien à retenir.',
    methodPasswordHint: 'Un lien de confirmation arrive dans ta boîte, puis tu te connectes avec ton mot de passe.',
    passwordLabel: 'Mot de passe',
    passwordPlaceholder: 'Au moins 8 caractères',
    passwordHint: 'Choisis-en un que tu retiendras : il ouvrira ton compte sur n’importe quel téléphone.',
    passwordShow: 'Afficher',
    passwordHide: 'Masquer',
    passwordTooShort: 'Au moins 8 caractères.',
    passwordTooCommon: 'Ce mot de passe est trop courant. Choisis-en un autre.',
    passwordTooLong: 'Mot de passe trop long.',

    haveAccount: 'J’ai déjà un compte',
    noAccount: 'Créer un compte',
    loginTitle: 'Te reconnecter',
    loginSubtitle: 'Ton quartier et tes publications te retrouvent',
    login: 'Me connecter',
    loginRefused: 'Adresse ou mot de passe incorrect.',
    loginLocked: 'Trop d’essais. Réessaie dans un quart d’heure.',
    loginUnconfirmed: 'Ton adresse n’est pas encore confirmée. Ouvre le lien reçu par e-mail.',
    forgotPassword: 'Mot de passe oublié ?',
    forgotSent: '✓ Si un compte existe pour cette adresse, un lien vient de partir.',

    confirmTitle: 'Regarde ta boîte',
    confirmSubtitle: 'Un lien de confirmation est parti vers {email}. Ouvre-le, puis reviens ici te connecter.',
    confirmNotSent: 'Le compte est créé, mais aucun e-mail ne peut être envoyé pour l’instant : l’envoi n’est pas encore branché sur le serveur.',
    confirmSpam: 'Rien après deux minutes ? Regarde dans les indésirables.',
    confirmResend: 'Renvoyer le lien',
    confirmResent: '✓ Un nouveau lien est parti.',
    confirmDone: 'C’est fait, me connecter',
